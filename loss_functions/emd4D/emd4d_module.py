...
class emdFourDFunction(Function):
    @staticmethod
    ...
    def backward(ctx, graddist, gradidx):
        ...
        emd4d.backward(xyz1, xyz2, gradxyz1, graddist, assignment)
        return gradxyz1, gradxyz2, None, None


class emd4dModule(nn.Module):
    def __init__(self):
        super(emd4dModule, self).__init__()

    def forward(self, input1, input2, eps, iters):
        return emdFourDFunction.apply(input1, input2, eps, iters)


def test_emd():
    x1 = torch.rand(20, 2048, 4).cuda()
    x2 = torch.rand(20, 2048, 4).cuda()
    emd = emd4dModule()
